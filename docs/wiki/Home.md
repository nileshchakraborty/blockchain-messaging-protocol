# Welcome to the BMP Wiki

**Blockchain Messaging Protocol** - A production-ready, end-to-end encrypted P2P messaging system.
...
BMP is a decentralized messaging protocol that combines:
...
- **File transfer** with chunking and hash verification
...
| ⚡ **High Performance** | 300K+ encryptions/sec, O(1) block lookups |
